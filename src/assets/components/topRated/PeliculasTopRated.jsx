...
import Styles from './peliculasTopRated.module.css';

const cargarPeliculasTopRated = async (pagina, setPeliculas, setError) => {
    try {
        const respuesta = await fetch(`https://api.themoviedb.org/3/movie/top_rated?api_key=cace972f4626db6a5ee3ae755a24b03d&language=es-MX&page=${pagina}`);
...
export const PeliculasTopRated = () => {
    ...
    useEffect(() => {
        cargarPeliculasTopRated(pagina, setPeliculas, setError);
